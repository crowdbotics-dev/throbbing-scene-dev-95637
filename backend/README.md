...
## Project Structure
    ...
    ├── throbbing_scene_dev_95637  # Django project configurations
...
1. Clone this repo and `cd throbbing_scene_dev_95637`
...
2. Clone this repo and `cd throbbing_scene_dev_95637`
